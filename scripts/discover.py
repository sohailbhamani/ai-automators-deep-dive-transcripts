#!/usr/bin/env python3
"""
Discover new Deep Dive With The AI Automators videos via YouTube RSS feed.
...
CHANNEL_ID = "UCUCU2q6VGU1gxAcEZcipzaw"
    ...
    for attempt in range(1, retries + 1):
        try:
            req = urllib.request.Request(
                RSS_URL,
                headers={"User-Agent": "AIAutomatorsDeepDiveTranscripts/1.0"},
            )
...
def main():
    print("=== Deep Dive With The AI Automators Video Discovery (RSS) ===")
